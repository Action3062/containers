...
Welcome to our container images, if looking for a container start by [browsing the container packages](https://github.com/Action3062?tab=packages&repo_name=containers).
...
| Container                                          | Immutable |
|----------------------------------------------------|-----------|
| `ghcr.io/action3062/sonarr:rolling`                   | ❌         |
| `ghcr.io/action3062/sonarr:3.0.8.1507`                | ❌         |
| `ghcr.io/action3062/sonarr:rolling@sha256:8053...`    | ✅         |
| `ghcr.io/action3062/sonarr:3.0.8.1507@sha256:8053...` | ✅         |
